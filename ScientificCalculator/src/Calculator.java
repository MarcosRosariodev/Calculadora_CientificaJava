...
public class Calculator {
	...
	private void initialize() {
		...
		btnDot.setFont(new Font("Tohama", Font.PLAIN, 21));
		...
		btnMu1.setFont(new Font("Tahoma", Font.PLAIN, 21));
		...
		separator.setBounds(19, 191, 1, 2);
		frame.getContentPane().add(separator_1);
		
		JSeparator separator_2 = new JSeparator();
		separator.setBounds(10, 191, 320, 2);
